...
public abstract class RankingCategory extends RecordCategory {
	...
	protected void registerRanking(RecordDomain domain, String rankDBName) {
		...
		register(mostWeeksAt(domain, TOP_4, TOP_4_NAME, rankDBName, TOP_4_RANK, TOP_4_RANK));
		...
		register(mostConsecutiveWeeksAt(domain, TOP_4, TOP_4_NAME, rankDBName, TOP_4_RANK, TOP_4_RANK));
		...
		if (domain == ALL) {
			...
			register(mostEndsOfSeasonAt(TOP_4, TOP_4_NAME, rankDBName, TOP_4_RANK));
			...
			register(mostConsecutiveEndsOfSeasonAt(TOP_4, TOP_4_NAME, rankDBName, TOP_4_RANK));
		...
		register(youngestOldestRanking(domain, YOUNGEST, TOP_4, TOP_4_NAME, rankDBName, TOP_4_RANK));
		...
		register(youngestOldestRanking(domain, OLDEST, TOP_4, TOP_4_NAME, rankDBName, TOP_4_RANK));
		...
		register(careerSpanRanking(domain, TOP_4, TOP_4_NAME, rankDBName, TOP_4_RANK));
		...
		if (domain == ALL && rankClass != RankClass.ELO) {
			...
			register(youngestOldestEndOfSeasonRanking(domain, YOUNGEST, TOP_4, TOP_4_NAME, rankDBName, TOP_4_RANK));
			...
			register(youngestOldestEndOfSeasonRanking(domain, OLDEST, TOP_4, TOP_4_NAME, rankDBName, TOP_4_RANK));
			...
			register(careerSpanEndOfSeasonRanking(domain, TOP_4, TOP_4_NAME, rankDBName, TOP_4_RANK));
	...
	protected Record mostWeeksAt(RecordDomain domain, String id, String name, String rankDBName, String condition, String bestCondition) {
		return new Record<>(
			...
			List.of(new RecordColumn("value", "numeric", null, WEEKS_WIDTH, "right", "Weeks At " + name))
		);
	}
	...
	protected Record mostEndsOfSeasonAt(String id, String name, String rankDBName, String condition) {
		return new Record<>(
			...
			List.of(new RecordColumn("value", "numeric", null, SEASONS_WIDTH, "right", "Seasons at " + name))
		);
	}
	...
	protected Record mostTimesAt(RecordDomain domain, String id, String name, String rankDBName, String condition, String bestCondition) {
		return new Record<>(
			...
			IntegerRecordDetail.class, (playerId, recordDetail) -> format("/playerProfile?playerId=%1$d&tab=ranking&rankType=%2$s", playerId, rankType),
			List.of(new RecordColumn("value", "numeric", null, TIMES_WIDTH, "right", "Times at " + name))
		);
	}
